<template>
    <div class="min-h-screen bg-gradient-to-br from-slate-50 to-slate-100">
        ...
        <main class="max-w-6xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
            ...
            <div v-if="user.role === 'PLAYER'" class="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-green-600">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-slate-900 mt-1">{{ stats.total_matches_played || 0 }}</p>
                        </div>
                ...
                <div class="bg-white rounded-xl shadow-md p-6 border-l-4 border-purple-600">
                    <div class="flex items-center justify-between">
                        <div>
                            ...
                            <p class="text-3xl font-bold text-slate-900 mt-1">{{ stats.sportsmanship_rating || '5.0'
                            }}/5.0</p>
                        </div>
...
// Mock user data - replace with actual auth store/API
const user = ref({
    full_name: 'John Doe',
